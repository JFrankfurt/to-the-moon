...
let mainMenu = {
  create: function() {
    ...
    this.title()
    text = this.game.add.text(24, 10, 'Play', {
      font: '16px Arial',
      fill: '#ffffff',
    })
...
let Play = {
  create: function() {
    ...
    //The level
    levelString = 'Level : '
    levelText = this.game.add.text(10, 50, levelString + level, {
      font: '34px Arial',
      fill: '#fff',
    })
    ...
    satoshiText = this.game.add.text(10, 90, satoshiString + satoshis, {
      font: '34px Arial',
      fill: '#fff',
    })
  ...
  createAliens: function() {
    ...
    let tween = this.game.add
      .tween(aliens)
      .to({ x: 308 }, 2500, Phaser.Easing.Sinusoidal.InOut, true, 0, 1000, true)
  },
